import { AlertCircle, X, Home, TrendingUp, Search } from 'lucide-react';
    ...
    <>
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[90%] max-w-md">
        <div className="relative group">
          {/* Glow Effect */}
          <div className="absolute -inset-1 bg-gradient-to-r from-orange-500/40 via-red-500/40 to-orange-500/40 rounded-2xl opacity-75 blur-xl animate-pulse"></div>
          
          {/* Main Card */}
          <div className="relative bg-white rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.3)] overflow-hidden">
            {/* Header with gradient */}
            <div className="relative px-6 pt-8 pb-6 bg-gradient-to-br from-orange-50 via-white to-red-50">
              ...
              <div className="flex justify-center mb-4">
                <div className="relative">
                  ...
                  <div className="relative p-4 rounded-full bg-gradient-to-br from-orange-500 to-red-500">
            ...
            <div className="px-6 pb-6">
              <div className="mb-6">
                <p className="text-[#6A6A6A] text-[14px] sm:text-[15px] text-center leading-relaxed mb-4">
                  Financial data on some properties is missing. You have entered such a property. We're working on fixing this issue—please try a different property.
                </p>

                {/* Info Cards */}
                <div className="space-y-3">
                  <div className="p-4 rounded-xl bg-gradient-to-br from-orange-50 to-white border border-orange-500/30">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[#6A6A6A] text-[12px] leading-relaxed">
                          Complete financial data is currently unavailable for this address
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-gradient-to-br from-[#005BFF]/5 to-white border border-[#005BFF]/20">
                    <div className="flex items-start gap-3">
                      <div className="p-2 rounded-lg bg-[#005BFF]/10 mt-0.5">
                        <Search className="text-[#005BFF]" size={16} />
                      </div>
                      <div className="flex-1">
                        <h3 className="text-black text-[13px] font-medium mb-1">
                        ...
                        <p className="text-[#6A6A6A] text-[12px] leading-relaxed">
                          Most properties in our database have complete financial analysis available
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-[#6A6A6A] text-[11px] text-center">
                  We're working to add this property's data to our database soon
                </p>
              </div>
            </div>
          </div>
