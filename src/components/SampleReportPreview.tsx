...
export function SampleReportPreview() {
  ...
  return (
    <section id="sample-report" className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_25%,rgba(0,0,0,0.3)_0%,transparent_35%),radial-gradient(circle_at_85%_75%,rgba(24,163,111,0.12)_0%,transparent_35%),radial-gradient(circle_at_50%_50%,rgba(0,0,0,0.08)_0%,transparent_50%)]"></div> */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-black backdrop-blur-xl border border-[#000]/10 shadow-[0_0_0_1px_rgba(0,0,0,0.5)_inset,0_8px_16px_rgba(0,91,255,0.08)]">
            <div className="w-2 h-2 rounded-full bg-gradient-to-r from-[#005BFF] to-[#005bff] animate-pulse"></div>
            <span className="text-[#fff] text-[11px] font-medium uppercase tracking-wider">Sample Intelligence</span>
          </div>
        </div>

        {/* Title */}
        <div className="text-center mb-16 lg:mb-20">
          <h2 className="text-black text-[44px] lg:text-[64px] mb-6 tracking-[-0.04em] font-[700] leading-[1.05]">
            See What You'll <span className="bg-gradient-to-r from-gray-500 to-gray-500  bg-clip-text text-transparent">Unlock</span>
          </h2>
            ...
            <div className="relative bg-white/70 backdrop-blur-2xl border border-white/60 rounded-[28px] shadow-[0_0_0_1px_rgba(255,255,255,0.8)_inset,0_24px_48px_rgba(0,0,0,0.10),0_8px_16px_rgba(0,91,255,0.08)] overflow-hidden hover:shadow-[0_0_0_1px_rgba(255,255,255,0.9)_inset,0_32px_64px_rgba(0,0,0,0.12),0_12px_24px_rgba(0,91,255,0.12)] transition-all duration-500 hover:translate-y-[-4px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-white/5 via-white/30 to-white/75 backdrop-blur-[0.5px] z-10 flex items-end justify-center pb-8">
                <div className="bg-black backdrop-blur-xl rounded-xl px-4 py-2.5 shadow-[0_0_0_1px_rgba(0,91,255,0.1),0_20px_40px_rgba(0,0,0,0.15)] group-hover:scale-105 transition-all duration-500 flex items-center gap-2.5 border border-[#005BFF]/10">
                  ...
                  <div className="text-left">
                    <p className="text-white font-medium text-[13px] mb-0">Unlock Full Report</p>
              ...
              <div className="p-8 space-y-6 ">
                ...
                <div className="space-y-3">
                  <div className="h-8 bg-gradient-to-r from-[#000] via-[#000] to-[#000]/80 w-4/5 rounded-xl shadow-[0_4px_12px_rgba(0,91,255,0.25)]"></div>
            ...
            {features.map((feature, index) => (
              <div key={index} className="group bg-white/60 backdrop-blur-xl border border-white/60 rounded-2xl p-5 shadow-[0_0_0_1px_rgba(255,255,255,0.5)_inset,0_8px_16px_rgba(0,0,0,0.04)] hover:shadow-[0_0_0_1px_rgba(255,255,255,0.8)_inset,0_16px_32px_rgba(0,0,0,0.08)] hover:bg-white/80 transition-all duration-300 hover:translate-x-1">
                <div className="flex items-start gap-3.5">
                  <div className="mt-0.5 flex-shrink-0 w-7 h-7 rounded-xl bg-gradient-to-br from-[#000] to-[#000] flex items-center justify-center border border-[#000]/20 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-[0_2px_8px_rgba(24,163,111,0.1)]">
                    <Check className="text-[#fff]" size={14} strokeWidth={3} />
                  </div>
