...
var brand_privateStreamingFile = Symbol("brand.privateStreamingFile");
function toStreamingFile(data, name, options) {
  ...
  return {
    ...
    data,
    name,
    ...(options == null ? void 0 : options.type) ? { type: options.type } : {}
  };
}
...
var ChatCompletionStream = class _ChatCompletionStream extends AbstractChatCompletionRunner {
  ...
  async _fromReadableStream(readableStream, options) {
    ...
    for await (const item of stream) {
      if (isChatCompletionReadableStreamMessage(item)) {
        ...
        if (__classPrivateFieldGet(this, _ChatCompletionStream_currentChatCompletionSnapshot, "f")) {
          ...
          for (const [index, id] of ((_b = message.tool_call_ids) == null ? void 0 : _b.entries()) ?? []) {
    ...
    if ((_c = stream.controller.signal) == null ? void 0 : _c.aborted) {
      throw new APIUserAbortError();
    }
    if (__classPrivateFieldGet(this, _ChatCompletionStream_currentChatCompletionSnapshot, "f")) {
      return this._addChatCompletion(__classPrivateFieldGet(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_endRequest).call(this));
  ...
  [(_ChatCompletionStream_params = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_audioDoneChoiceIndexes = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_choiceEventStates = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_currentChatCompletionSnapshot = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_instances = /* @__PURE__ */ new WeakSet(), _ChatCompletionStream_beginRequest = function _ChatCompletionStream_beginRequest2() {
    ...
    for (const choice of chunk.choices) {
      ...
      const { delta } = choice;
      if ((delta == null ? void 0 : delta.content) != null && ((_a3 = choiceSnapshot.message) == null ? void 0 : _a3.role) === "assistant" && ((_b = choiceSnapshot.message) == null ? void 0 : _b.content)) {
      ...
      if ((delta == null ? void 0 : delta.refusal) != null && ((_c = choiceSnapshot.message) == null ? void 0 : _c.role) === "assistant" && ((_d = choiceSnapshot.message) == null ? void 0 : _d.refusal)) {
      ...
      for (const toolCall of (delta == null ? void 0 : delta.tool_calls) ?? []) {
      ...
      for (const toolCallDelta of (delta == null ? void 0 : delta.tool_calls) ?? []) {
...
var OpenAI = class {
  ...
  constructor(clientOptions = {}) {
    ...
    const options = {
      ...
      provider,
      ...opts,
      baseURL: (providerRuntime == null ? void 0 : providerRuntime.baseURL) ?? (baseURL || `https://api.openai.com/v1`)
    };
  ...
  async makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
    ...
    const hasStreamingBody = ((_a3 = options.__metadata) == null ? void 0 : _a3["hasStreamingBody"]) === true;
    ...
    if (!response.ok) {
      if (response.status === 401 && this._workloadIdentityAuth && security.bearerAuth && !((_f = options.__metadata) == null ? void 0 : _f["hasStreamingBody"]) && !((_g = options.__metadata) == null ? void 0 : _g["workloadIdentityTokenRefreshed"])) {
...
function deriveBedrockBaseURL(awsRegion) {
  const region = awsRegion == null ? void 0 : awsRegion.trim();
  if (!region) {
...
function normalizeBedrockBaseURL(baseURL) {
  ...
  if ((responsesMatch == null ? void 0 : responsesMatch.index) !== void 0) {
...
var BedrockOpenAI = class extends OpenAI {
  ...
  constructor({ baseURL = readEnv("AWS_BEDROCK_BASE_URL"), apiKey, awsRegion = readEnv("AWS_REGION") ?? readEnv("AWS_DEFAULT_REGION"), bedrockTokenProvider, adminAPIKey, workloadIdentity, ...opts } = {}) {
    ...
    const configuredBaseURL = (baseURL == null ? void 0 : baseURL.trim()) ? baseURL : deriveBedrockBaseURL(awsRegion);
    super({
